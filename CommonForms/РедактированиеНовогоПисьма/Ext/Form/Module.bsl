...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокАдресовОтвета = ХранилищеОбщихНастроек.Загрузить("РедактированиеНовогоПисьма", "СписокАдресовОтвета", , ОбщегоНазначения.ТекущийПользователь());
...
// Вызывает функцию заполнения списка вложений
//
&НаКлиенте
...
// Обработчик события нажатия на кнопку "Отправить письмо" формы
// 
&НаКлиенте
...
// Обработчик события "обработка выбора" поля УчетнаяЗапись
...
// Обработчик события "окончание ввода текста" поля АдресОтвета.
// Если введенный почтовый адрес отличается от заполненного по умолчанию
//
&НаКлиенте
...
// Обработчик события "обработка выбора" поля АдресОтвета.
...
// Обработчик события "очистика" поля АдресОтвета.
//
&НаКлиенте
...
// Обработчик события "перед удалением" поля Вложения
...
// Обработчик события нажатия на кнопку командной панели "приложить файл"
//
&НаКлиенте
...
// Обновляет представление списка вложений
// 
//
&НаКлиенте
...
Функция АктуализироватьАдресОтветаВХранимомСписоке(знач АдресОтвета,
	...
	// Получаем список адресов, которые пользователь использовал ранее
	СписокАдресовОтвета = ХранилищеОбщихНастроек.Загрузить(
...
// Возвращает приведенный почтовый адрес
//
&НаКлиенте
...
Процедура ЭлектронныйАдресКомуНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	//ОткрытьФорму("Справочник.АдреснаяКнигаЭлектроннойПочты.Форма.ФормаВыбора");
	Адрес = "";
