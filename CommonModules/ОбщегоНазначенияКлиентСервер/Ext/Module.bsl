...
Функция СформироватьЗаголовокДокумента(Шапка, знач НазваниеДокумента = "") Экспорт
	...
	//	НСтр("ru = '%1 № %2 от %3'"),
	//	НазваниеДокумента, ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(Шапка.Номер),
	//	Формат(Шапка.Дата, "ДФ='дд ММММ гггг'"));
	
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = '%1 № %2 от %3'"),
		НазваниеДокумента, Строка(Шапка.Номер),
		Формат(Шапка.Дата, "ДФ='дд ММММ гггг'"));
КонецФункции
